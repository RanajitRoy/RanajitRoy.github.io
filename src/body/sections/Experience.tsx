            ...
            <div id="exp-container">
                <div className="ExpItem">
                    ...
                    <ul className="ExpDescription">
                        ...
                        <li>Created an email generation and delivery service for weekly marketing email campaigns targeting 1000+ customers</li>
                ...
                <div className="ExpItem">
                    ...
                    <ul className="ExpDescription">
                        ...
                        <li>Collaborated in the design of a scalable AWS cloud infrastructure from requirement gathering to its translation</li>
                        <li>Spearheaded transition towards a decoupled parallel architecture using .NET from a former monolithic design resulting in a remarkable 600% increase in system throughput while enhancing overall system maintainability</li>
                        <li>Revamped a shape recognition module for CADs with the .NET Framework, attaining over 99% accuracy in identifying 200+ shapes across extensive file sets and reducing false errors by 75% compared to the prior solution</li>
                        <li>Supervised a team of 3 interns on migrating the entire codebase from C# to Java for enhanced library support</li>
